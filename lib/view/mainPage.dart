...
import 'package:my_portfolio/view/projects/projects.dart';
...
class _MainPageState extends State<MainPage> {
    ...
    return PreferredSize(
      ...
      child: AppBar(
        ...
        actions: [
          ...
          Container(padding: EdgeInsets.only(top: 4) ,child: dropDownButtonBuild(_localProvider, _themeProvider)),
          const SizedBox(width: 15.0),
          Icon(Icons.dark_mode_outlined, color: _themeProvider.lightTheme? Colors.black : Colors.white,),
          SizedBox(
            height: 30.0,
            child: Switch(
  ...
  Widget _appBarMobile(ThemeProvider _themeProvider, LocaleProvider _localProvider) {
    Color? switchColor =  _themeProvider.lightTheme ? Colors.black : Colors.white;
          ...
          child: Column(
            ...
            children: [
              ...
              ListTile(
                ...
                title: Text(AppLocalizations.of(context)!.about_mobile_tile_darkmode,
                    style: TextStyle(
                        color: switchColor)),
                trailing: Switch(
                  inactiveTrackColor: Colors.grey,
              ...
              ListTile(
                ...
                title: Text(AppLocalizations.of(context)!.about_mobile_tile_language,
                    style: TextStyle(
                        color: switchColor)),
                trailing: dropDownButtonBuild(_localProvider, _themeProvider)),
              Divider(
                color: _themeProvider.lightTheme ? Colors.grey[600] : Colors.white,
              ),
              for (int i = 0; i < _sectionsName.length; i++)
                _appBarActions(_sectionsName[i], i, _sectionsIcons[i], _themeProvider),
                Spacer(),
                Row(
